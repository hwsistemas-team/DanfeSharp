...
namespace DanfeSharp.Modelo
{
    ...
    {
        private static XmlSerializer ProcNFeSerializer = new XmlSerializer(typeof(ProcNFeEvento));

        internal static DanfeEventoViewModel CreateFromXmlString(string xml)
        {
            ProcNFeEvento nfe = null;
            try
            {
                using (var reader = new StringReader(xml))
                {
                    nfe = (ProcNFeEvento)ProcNFeSerializer.Deserialize(reader);
                }
        ...
        public static DanfeEventoViewModel CreateFromXml(ProcNFeEvento procEvento)
        {
            ...
            var model = new DanfeEventoViewModel
            {
                ...
                Orgao = infEvento.cOrgao.Descricao().ToUpper(),
