...
namespace DanfeSharp.Esquemas
{
    ...
    public sealed class ProcNFeEvento
    {
        /// <summary>
    ...
    public sealed class NFeRetEvento
    {
        public NFeVersao Versao { get; set; }
    ...
    public sealed class NFeRetInfEvento : GenericClone<NFeRetInfEvento>
    {
        /// <summary>
    ...
    public sealed class NFeInfEvento : GenericClone<NFeInfEvento>
    {
        /// <summary>
    ...
    public sealed class NFeDetEvento
    {
        /// <summary>
